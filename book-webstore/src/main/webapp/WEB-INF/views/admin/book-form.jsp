...
<body class="bg-light">
    ...
    <div class="container py-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h2 class="fw-bold mb-0">${empty book.id ? 'Thêm Sách Mới' : 'Chỉnh Sửa Sách'}</h2>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 text-muted">
                        ...
                        <li class="breadcrumb-item"><a href="${pageContext.request.contextPath}/admin/books">Sách</a></li>
                        <li class="breadcrumb-item active">${empty book.id ? 'Tạo mới' : 'Cập nhật'}</li>
                    </ol>
                </nav>
            </div>
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="card shadow-sm border-0 mb-4">
                        <div class="card-header bg-white py-3 border-bottom"><h5 class="mb-0 fw-bold">Thông Tin Cơ Bản</h5></div>
                    ...
                    <div class="card shadow-sm border-0 mb-4">
                        <div class="card-header bg-white py-3 border-bottom"><h5 class="mb-0 fw-bold">Giá & Tồn Kho</h5></div>
                        <div class="card-body p-4">
                            <div class="row g-3">
                                <div class="col-md-6">
                    ...
                    <div class="card shadow-sm border-0 mb-4">
                        <div class="card-header bg-white py-3 border-bottom"><h5 class="mb-0 fw-bold">Album Hình Ảnh</h5></div>
                        <div class="card-body p-4">
                            <div class="upload-area border-2 border-dashed p-4 rounded bg-light text-center" id="uploadArea" style="cursor: pointer;">
                                ...
                                <p class="mb-0 fw-bold">Click để chọn nhiều ảnh (Tối đa 5 ảnh)</p>
                            ...
                            <c:if test="${not empty book.id and not empty book.images}">
                                <div class="mt-4 pt-3 border-top">
                                    <p class="small fw-bold text-muted mb-2">Ảnh hiện đang lưu:</p>
                                    <div class="row g-2">
                                    ...
                                    <small class="text-danger mt-2 d-block">* Tải ảnh mới lên sẽ thay thế album cũ.</small>
                                </div>
                            </c:if>
                        </div>
                    </div>
                ...
                <div class="col-lg-4">
                    <div class="card border-0 shadow-sm sticky-top" style="top: 20px;">
                        <div class="card-header bg-white py-3 border-bottom"><strong><i class="fas fa-eye me-2"></i>Xem trước hiển thị</strong></div>
