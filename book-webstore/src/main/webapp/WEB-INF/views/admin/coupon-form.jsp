                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav me-auto">
                            ...
                            <li class="nav-item"><a class="nav-link"
                                    href="${pageContext.request.contextPath}/admin/books">Quản lý sách</a></li>
                            <li class="nav-item"><a class="nav-link"
                                    href="${pageContext.request.contextPath}/admin/authors">Tác giả</a></li>
                            <li class="nav-item"><a class="nav-link"
                                    href="${pageContext.request.contextPath}/admin/categories">Danh mục</a></li>
                            <li class="nav-item"><a class="nav-link active"
                                    href="${pageContext.request.contextPath}/admin/coupons">Coupon</a></li>
                        </ul>
                        <ul class="navbar-nav">
                            <li class="nav-item">
                                <a class="nav-link" href="${pageContext.request.contextPath}/"><i
                                        class="fas fa-home me-1"></i> Về trang chủ</a>
                            </li>
                        </ul>
                    </div>
                </div>
                        ...
                        <div class="card border-0 shadow-sm overflow-hidden">
                            ...
                            <div class="list-group list-group-flush sidebar-nav">
                                ...
                                <a href="${pageContext.request.contextPath}/admin/coupons/add"
                                    class="list-group-item list-group-item-action border-0 px-4 py-3 ${coupon.id == null ? 'active' : ''}">
                    ...
                    <div class="col-md-9">
                        <div class="d-flex justify-content-between align-items-center mb-4">
                            <h2 class="fw-bold text-dark">
                                <i class="fas fa-ticket-alt me-2 text-primary"></i>${coupon.id == null ? 'Tạo coupon
                                mới' : 'Cập nhật coupon'}
                            </h2>
                            <a href="${pageContext.request.contextPath}/admin/coupons"
                                ...
                                <form method="post" action="${pageContext.request.contextPath}/admin/coupons/save"
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select class="form-select" id="discountType" name="type" required>
                                            <option value="PERCENTAGE" ${coupon.type=='PERCENTAGE' ? 'selected' : '' }>
                                                Phần trăm</option>
                                            <option value="FIXED" ${coupon.type=='FIXED' ? 'selected' : '' }>Số tiền cố
                                                định</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <label class="form-label fw-semibold">
                                            Giá trị (<span id="valueUnit">%</span>)
                                        </label>
                                        <div class="input-group">
                                            <input type="number" id="discountValue" step="1" min="1"
                                                class="form-control" name="value" value="${coupon.value}" required>
                                            <span class="input-group-text" id="valueUnitText">%</span>
                                        </div>
                                    </div>
