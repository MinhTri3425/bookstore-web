                        ...
                        <form method="post" action="${pageContext.request.contextPath}/admin/coupons/save"
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control fw-bold text-primary" name="code"
                                    value="${coupon.code}" placeholder="Ví dụ: GIAMGIA2026" required ${coupon.id !=null
                                    ? 'readonly' : '' }>
                            ...
                            <div class="col-md-4">
                                ...
                                <select class="form-select" id="discountType" name="type" required>
                                    <option value="PERCENTAGE" ${coupon.type=='PERCENTAGE' ? 'selected' : '' }>Phần trăm
                                        (%)</option>
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="number" step="1000" min="0" class="form-control" name="minOrderValue"
                            ...
                            <div class="col-md-3" id="maxDiscountWrap">
                                ...
                                <input type="number" step="1000" min="0" class="form-control" name="maxDiscountValue"
                                    value="${coupon.maxDiscountValue}">
                            </div>
                            ...
                            <div class="col-md-4 d-flex align-items-end px-4">
                                <div class="form-check form-switch p-3 bg-light rounded w-100 border">
                                    ...
                                    <label class="form-check-label fw-bold text-success" for="active">Kích hoạt Coupon
                                        ngay</label>
                                </div>
                            </div>
