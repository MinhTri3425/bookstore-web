            ...
            <form class="row g-3" method="get" action="${pageContext.request.contextPath}${listPath}">
                <div class="col-md-5">
                    ...
                    <input id="orderId" name="orderId" type="text" class="form-control" 
                           value="${searchOrderId}" placeholder="VD: 123...">
                </div>
                <div class="col-md-4">
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a class="btn btn-sm btn-outline-primary" 
                                       href="${pageContext.request.contextPath}${detailBasePath}/admin/orders/${order.id}">
                    ...
                    <ul class="pagination pagination-sm mb-0">
                        <c:forEach var="pageIndex" begin="0" end="${totalPages - 1}">
                            <c:url var="pageUrl" value="${listPath}">
                                ...
                                <c:if test="${not empty searchOrderId}"><c:param name="orderId" value="${searchOrderId}" /></c:if>
                            </c:url>
