<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        ...
        <body>
                ...
                <%-- Header: Thông tin Shipper --%>
                    <div class="card border-0 shadow-sm mb-3">
                        <div class="card-body d-flex justify-content-between align-items-center">
                            <div>
                                <h5 class="mb-0 fw-bold text-dark">Chào, <span
                                        class="text-primary">${shipper.name}</span></h5>
                                <small class="text-success"><i class="fas fa-circle me-1" style="font-size: 8px;"></i>
                                    Đang trực tuyến</small>
                            </div>
                    ...
                    <%-- Thanh công cụ nhanh --%>
                        <div class="row g-2 mb-4">
                            <div class="col-12">
                                <a href="/shipper/history"
                                    class="btn btn-white border w-100 py-2 shadow-sm text-dark fw-bold">
                        ...
                        <%-- Thông báo thao tác --%>
                            ...
                            <c:if test="${param.success == 'delivered'}">
                                <div class="alert alert-primary alert-dismissible fade show border-0 shadow-sm"
                                    role="alert">
                            ...
                            <%-- PHẦN 1: CHỢ ĐƠN HÀNG (Đơn chung chưa ai nhận) --%>
                                <div class="d-flex align-items-center mb-3">
                                    <h5 class="mb-0 text-danger fw-bold"><i class="fas fa-store me-2"></i>Chợ đơn hàng
                                        mới</h5>
                                ...
                                <c:choose>
                                            ...
                                            <div
                                                ...
                                                <div class="card-body p-3">
                                                    <div class="d-flex justify-content-between align-items-start mb-2">
                                                        <div>
                                                            <small class="text-muted d-block">Mã đơn:
                                                                #${item.orderId}</small>
                                                            <strong
                                                                class="text-dark d-block mb-1">${item.customerAddress}</strong>
                                                        </div>
                                                        <span
                                                            class="badge bg-light text-danger border border-danger badge-status">CÓ
                                                            ĐƠN MỚI</span>
                                                    </div>

                                                    <div class="small text-muted mb-3">
                                                        <i class="fas fa-sticky-note me-1"></i> Ghi chú: ${not empty
                                                    ...
                                                    <form action="/shipper/pick-up" method="post">
                                                        ...
                                                        <button type="submit"
                                                            class="btn btn-pickup w-100 fw-bold py-2 shadow-sm">
                                    ...
                                    <c:otherwise>
                                        <div class="text-center py-4 bg-white rounded border border-dashed mb-4">
                                            <p class="text-muted mb-0 small italic">Hiện tại chưa có đơn hàng nào trong
                                                chợ...</p>
                                        </div>
                                    </c:otherwise>
                                </c:choose>
                                ...
                                <%-- PHẦN 2: NHIỆM VỤ ĐANG THỰC HIỆN (Đơn đã nhận) --%>
                                    <h5 class="mb-3 text-primary fw-bold"><i class="fas fa-truck me-2"></i>Nhiệm vụ bạn
                                        đang giao:</h5>
                                    ...
                                    <c:choose>
                                        <c:when test="${not empty myActiveOrders}">
                                            <c:forEach var="order" items="${myActiveOrders}">
                                                <div
                                                    class="card mb-3 shadow border-0 border-start border-primary border-4">
                                                    <div class="card-body p-3">
                                                        <div
                                                            class="d-flex justify-content-between align-items-center mb-3">
                                                            <h6 class="fw-bold text-primary mb-0">Đơn hàng
                                                                #${order.orderId}</h6>
                                                        ...
                                                        <div class="bg-light p-3 rounded mb-3">
                                                            ...
                                                            <div>
                                                                <a href="tel:${order.customerPhone}"
                                                                    ...
                                                                    ${order.customerPhone} (Bấm để gọi)
                                                                </a>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <button type="button"
                                                            class="btn btn-success w-100 fw-bold py-2 shadow-sm btn-confirm-delivered"
                                        ...
                                        <c:otherwise>
                                            <div class="text-center py-5 bg-white rounded border">
                                                ...
                                                <small class="text-primary mt-2 d-block">Hãy nhặt đơn ở "Chợ đơn hàng"
                                                    phía trên!</small>
                                            </div>
                                        </c:otherwise>
                                    </c:choose>
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content border-0 shadow">
                        <div class="modal-header">
                            <h5 class="modal-title"><i class="fas fa-check-circle text-success me-2"></i>Xác nhận giao
                                thành công</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                            Bạn xác nhận đã thu tiền và giao thành công đơn hàng <strong
                                id="deliveredOrderIdText"></strong>?
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-outline-secondary"
                                data-bs-dismiss="modal">Đóng</button>
                            <form action="/shipper/complete" method="post" id="confirmDeliveredForm" class="d-inline">
            ...
            <script>
                (function () {
                    const orderIdInput = document.getElementById('deliveredOrderIdInput');
                    const orderIdText = document.getElementById('deliveredOrderIdText');
                    if (!orderIdInput || !orderIdText) {
                        return;
                    }

                    document.querySelectorAll('.btn-confirm-delivered').forEach(function (button) {
