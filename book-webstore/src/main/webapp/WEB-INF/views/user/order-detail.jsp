    ...
    <div class="row g-4">
        ...
        <div class="col-lg-9">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <a href="${pageContext.request.contextPath}${backPath}" class="text-decoration-none small text-muted">Quay lại đơn hàng của tôi</a>
            ...
            <div class="row g-4 mb-4">
                <div class="col-lg-6">
                    <div class="card border-0 shadow-sm h-100">
                        <div class="card-header bg-white py-3"><h5 class="mb-0">Thông tin đơn hàng</h5></div>
                        <div class="card-body">
                            <div class="row g-3">
                                ...
                                <div class="col-sm-6"><strong>Tạm tính:</strong><div>${order.subtotalAmountDisplay}</div></div>
                                <div class="col-sm-6"><strong>Giảm giá:</strong><div>${order.discountAmountDisplay}</div></div>
                                <div class="col-sm-6"><strong>Mã coupon:</strong><div>${order.couponCode}</div></div>
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-white py-3"><h5 class="mb-0">Thao tác</h5></div>
                <div class="card-body">
                    <c:choose>
                        <c:when test="${order.canCancel}">
                            <form method="post" action="${pageContext.request.contextPath}/my-orders/${order.id}/cancel">
                                <button class="btn btn-danger" type="submit">
                                    <i class="fas fa-times me-2"></i>Hủy đơn hàng
                                </button>
                            </form>
                            <div class="form-text mt-2">Bạn chỉ có thể hủy đơn khi đơn còn ở trạng thái PENDING.</div>
                        </c:when>
                        <c:otherwise>
